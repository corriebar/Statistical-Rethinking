...
The model mostly stays between 0cm and 250cm. It still goes quite extrem and also has negative growth but otherwise it doesn't look to unreasonable.
...
Most students at first year would be exptexted to be between 50cm and 200cm tall. 
...
What is happening here? Everytime the slope parameter increases a bit, the intercept changes in the opposite direction, i.e. decreases.
