...
(1) How much does the influece of ruggedness (on GDP) depend upon whether the nation is in Africa?
...
In the bottom row, the influece of shade changes, depending on how much water there is.
If there is little water, the plant can't grow well, so no shade or a lot of shade doesn't change the bloom much. Whereas, if we have a more water, shade has a big difference, noticable in the steep slope.
